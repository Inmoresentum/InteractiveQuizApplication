...
const dialogprimitiveclassName = `
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg md:w-full`,
        className
      )}
      {...props}>
      {children}
      <DialogPrimitive.Close
        className={dialogprimitiveclassName}>
        <X className="h-4 w-4" />
