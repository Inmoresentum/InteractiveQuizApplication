        ...
        <>
            <div className="w-full py-[10rem] px-4 extra-bg">
                <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
                    <div
                        className='w-full shadow-2xl flex flex-col p-4 my-4 rounded-3xl hover:scale-105 duration-300 bg-white hover:shadow-violet-600'>
                    ...
                    <div
                        className='w-full shadow-2xl bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-3xl hover:scale-105 duration-300 hover:shadow-green-600'>
