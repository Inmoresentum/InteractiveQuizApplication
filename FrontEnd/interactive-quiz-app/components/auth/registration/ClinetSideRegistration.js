                  ...
                  {/*<RiMailLine size={24}/>*/}
                    <RiUserAddLine size={24}/>
                                ...
                                <input
                                    type="text"
                                    id="username"
                                    className="w-full pl-10 px-6 py-3 bg-opacity-20 bg-white bg-clip-padding backdrop-filter backdrop-blur-md placeholder-gray-500 focus:placeholder-gray-900 focus:outline-none focus:border-blue-500 rounded-3xl text-gray-800 text-base shadow-md"
                        ...
                        <div className="relative mb-6">
                            ...
                            <div className="relative flex">
                                <select
                                    ...
                                    className="h-12 bg-opacity-20 bg-white bg-clip-padding backdrop-filter backdrop-blur-md placeholder-gray-500 focus:placeholder-gray-900 focus:outline-none focus:border-blue-500 rounded-3xl text-gray-800 text-base shadow-md mr-0.5 mb-2"
                                >
                                    <option
                                        className="bg-opacity-20 bg-white bg-clip-padding backdrop-filter backdrop-blur-md placeholder-gray-500 focus:placeholder-gray-900 focus:outline-none focus:border-blue-500 rounded-3xl text-gray-800 text-base shadow-md"
                                        value="+880">+880
                                    </option>
                                    <option
                                        className="bg-opacity-20 bg-white bg-clip-padding backdrop-filter backdrop-blur-md placeholder-gray-500 focus:placeholder-gray-900 focus:outline-none focus:border-blue-500 rounded-3xl text-gray-800 text-base shadow-md"
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-[280px]  pl-10 px-6 py-3 bg-opacity-20 bg-white bg-clip-padding backdrop-filter backdrop-blur-md placeholder-gray-500 focus:placeholder-gray-900 focus:outline-none focus:border-blue-500 rounded-3xl text-gray-800 text-base shadow-md"
                            ...
                            <div class="flex items-center justify-center w-full">
                                <label htmlFor="dropzone-file"
                                       className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-400 border-dashed rounded-lg cursor-pointer bg-opacity-20 bg-white bg-clip-padding backdrop-filter backdrop-blur-md hover:bg-opacity-30 dark:hover:bg-opacity-30 dark:bg-gray-700 dark:border-gray-600 dark:hover:border-gray-500">
