    ...
    return (
        <main className="show-result-main-container">
            <div className="result-summary">
                <div className="results grid-flow"
                     data-spacing="large">
                ...
                <div className="summary grid-flow"
                    ...
                    <div className="grid-flow">
                        <div className="summary-item"
                            ...
                            <div className="flex-group">
                                <svg className="summary-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"
                                     viewBox="0 0 20 20">
                                ...
                                <svg className="summary-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"
                                    ...
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25"
                                          d="M16.447 13.004a3.334 3.334 0 0 0 .728-5.53m-.025-.067a2.083
                                           2.083 0 0 0-2.983-2.824M10 3.75a2.085 2.085 0 0
                                            1 2.538-2.033 2.084 2.084 0 0 1 1.43 2.92m-.635 12.03a1.667 1.667 0 0 1-3.333 0"/>
                                </svg>
                        ...
                        <div className="summary-item"
                            ...
                            <div className="flex-group">
                                <svg className="summary-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none"
                                     viewBox="0 0 20 20">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25"
                                          d="M7.5 10h5M10 18.333A8.333 8.333 0 1 0 1.667 10c0 1.518.406 2.942 1.115
                                           4.167l-.699 3.75 3.75-.699A8.295 8.295 0 0 0 10 18.333Z"/>
                                </svg>
                    ...
                    <button className="src-button">Continue</button>
                </div>
